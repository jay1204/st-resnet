...
train_image = ed()
train_image.batch_size = 64
#train_image.epoch = 10
train_image.drop_out = 0.9
train_image.augmentation = ['random_horizon_flip', 'random_border25_crop']#['random_horizon_flip', 'random_border25_crop']
train_image.clip_per_video = 1
train_image.learning_rate = 1e-3#1e-5
